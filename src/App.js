...
const sampleCookies = [
  {
    ...
    color: '#EAD8B7',
    image: 'https://i.postimg.cc/XJv3gj1V/f4a2c9e7c2e036cb30507ddb9fe74b12.jpg',
    calories: 340,
  ...
  },
  {
    ...
    color: '#6B4226',
    image: 'https://i.postimg.cc/0QNxCkXs/5df3e4565b5e4dd91275961381a950ec.jpg',
    calories: 360,
    allergens: ['Wheat', 'Soy'],
    reviews: [4, 4, 5, 5],
  ...
  },
  {
    ...
    color: '#E23E57',
    image: 'https://i.postimg.cc/85CDbpXT/d4fd190e8e581a9b633c5fd636494820.jpg',
    calories: 320,
      ...
      <div style={{ paddingTop: 74, paddingBottom: 120 }}>
        {cookieData.map((c, idx) => (
          <section
            ...
            style={{
              ...
              justifyContent: 'center',
              padding: '32px 20px',
              background: idx === selectedIndex ? c.color : 'transparent',
              ...
              >
                ...
                >
                  ...
                  >
                    <div>
                      <Stars
                        value={Math.round(c.reviews.reduce((a, b) => a + b, 0) / c.reviews.length)}
                      />
                    </div>
                    <button
        ...
        >
          <div style={{ maxWidth: 420, textAlign: 'center' }}>
            ...
            >
              Handcrafted cookies, baked fresh in the UK. Founded by Davi & Emily — made with love,
            ...
            >
              ...
              <a
                href="https://www.instagram.com/zumi.bakery.uk"
                target="_blank"
                rel="noreferrer"
